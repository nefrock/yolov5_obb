...
def random_perspective(im, targets=(), segments=(), degrees=10, translate=.1, scale_up=.1, scale_down=.1, shear=10, perspective=0.0,
                       border=(0, 0)):
    ...
    s = random.uniform(1 - scale_down, 1 + scale_up)
